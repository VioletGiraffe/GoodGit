...
their line counts and the commit's whole diff, a job each, so the rows may appear before their counts. The
topmost file is selected once the files arrive. Selecting a file cuts its section out of the whole
