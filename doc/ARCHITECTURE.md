...
`doc/UI/mockup.html`, generated by `doc/UI/mockup.gen.js`. What git and Mercurial themselves do, as
opposed to what this app does about it, is in `doc/git.md` and `doc/hg.md`.
...
| `messageedit` | The message editor with the subject guide column and word completion fed by one diff per refresh. Matching is case-insensitive, and words whose case the typed prefix already matches are offered first |
