...
const std::vector<Theme>& allThemes()
{
	...
	static const Theme classicLight{
		...
		.stModified = c(0x1668c4), .stAdded = c(0x12783c),
	...
	static const Theme classicDark{
		...
		.stModified = c(0x6cb0f0), .stAdded = c(0x62c98a),
	...
	static const Theme honey{
		...
		.stModified = c(0x1668c4), .stAdded = c(0x0d9c3c),
	...
	static const Theme blackoutViolet{
		...
		.stModified = c(0x6cb0f0), .stAdded = c(0x38e07c),
