...
TARGET   = gg
win32 {
	TEMPLATE = lib   # gg.dll, loaded by the launcher's gg.exe, see doc/BUILD.md
	CONFIG += dll
	CONFIG += skip_target_version_ext   # qmake otherwise appends VERSION's major to a dll's name
}
